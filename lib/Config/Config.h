...
const int VENT_SERVO_OPEN_ANGLE = 120;    // degrees when vent is open
...
const int LDR_INTENSE_THRESHOLD = 100;       // Analog reading at or below this = intense sunlight (LDR: lower = brighter)
